...
INSERT INTO "new_Urun" ("aciklama", "ad", "aktif", "barkod", "fiyat", "id", "kategori_id", "min_stok", "olusturma_tarihi", "stok_birim", "stok_takibi", "tur") SELECT "aciklama", "ad", "aktif", "barkod", "fiyat", "id", "kategori_id", "min_stok", "olusturma_tarihi", "stok_birim", "stok_takibi", "tur" FROM "Urun";
DROP TABLE "Urun";
